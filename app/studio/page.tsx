    ...
    <>
      ...
      <section id="spine-seq" className="spine-band">
        <div className="spine-stage">
          <h1 className="studio-hero-line"><span className="accent-yellow">think</span> as designers.</h1>
          <h1 className="studio-hero-line"><span className="accent-yellow">solve</span> as engineers.</h1>
          <h1 className="studio-hero-line"><span className="accent-yellow">commit</span> as partners.</h1>
        </div>
      </section>
